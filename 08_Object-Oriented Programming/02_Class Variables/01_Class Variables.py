...
# Class Variables are variables that are shared among all Class Instances of a Class.So, while Class Instances can be unique to each other (in terms of name, email and pay in this case),
