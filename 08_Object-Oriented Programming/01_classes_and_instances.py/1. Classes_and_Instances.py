...
# Class Instance is an object created from a Class. There can be multiple Class Instances created from a class.

# Each Class can have different attributes and methods:
# -> Attributes are characteristics of an object from the Class
# -> Methods are actions/behaviour of the object from the Class (usually done by defining functions  which will be associated with the Class)
...
#Lets say we are making an application for a company 
